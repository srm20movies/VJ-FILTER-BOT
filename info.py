...
PICS = (environ.get('PICS', 'https://graph.org/file/dd3dfae88a64f2c513fd7-e83eb4c94e0e14544b.jpg')).split()
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002389367717'))
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://bhaibhaiya770:bhaibhaiya770@cluster0.cntjf.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "bhaibhaiya770")
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/srm_movie')
